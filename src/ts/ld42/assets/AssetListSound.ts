namespace LD42 {
  // Imports
  import AssetTypeSound = Interfaces.AssetTypeSound;

  /**
   * UNLOCKR : LD42/Assets/AssetListSound
   * --------------------------------------------------------------------
   * Holds the array containing all the sounds and music used by the game.
   *
   * @author    Fabio Y. Goto <lab@yuiti.com.br>
   * @since     0.0.1
   */
  export const AssetListSound: Array<AssetTypeSound> = [
    {
      name: "ld42_intro",
      file: [
